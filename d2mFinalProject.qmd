...
```{r Setup-chunk,echo=FALSE,message=FALSE,warning=FALSE}
#| label: Setup-chunk 
...
gen_stats <- newset %>%
  ...
  mutate(Variable = case_when(
    Variable =="Right_Fixation"  ~ "Fixation Duration (Right Screen) (ms)",
    Variable == "Right_nFixation" ~ "Number of Fixations (Right Screen)",
    Variable == "Left_Fixation"   ~ "Fixation Duration (Left Screen) (ms)",
    Variable == "Left_nFixations" ~ "Number of Fixations (Left Screen)"
  )) %>%
